...
<head> <!-- head -->
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gothic+A1&family=Oswald:wght@200..700&family=Space+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">
</head>
<header>
